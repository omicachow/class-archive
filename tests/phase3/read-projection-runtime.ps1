...
function Get-Snapshot {
    ...
    Assert-True ($snapshot.result -eq 'PASS' -and [int]$snapshot.schema_version -eq 12 -and [int]$snapshot.incremental_contract -eq 1) 'read_projection_runtime_snapshot_invalid'
    return $snapshot
}
