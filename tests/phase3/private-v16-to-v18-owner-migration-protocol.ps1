...
Assert-True ($adapter.Contains("'attest-v16-to-v18-synthetic-direct-runtime.ps1'") -and $adapter.Contains('function Invoke-DirectV16ToV18ProofGate') -and $adapter.Contains("-Action verify") -and $adapter.Contains('attempt=attempt23') -and $adapter.Contains('direct_runtime_proof_gate_missing') -and $adapter.Contains('direct_runtime_proof_gate_head_stale')) 'private_v16_to_v18_direct_runtime_gate_invocation_missing'
