...
Assert-True ($runner.Contains('redirect=%252Findex.php%253F%252Fclass-archive-photo-app') -and $runner.Contains('page.waitForURL') -and $runner.Contains('home_projection_')) 'v4_scope_authenticated_bridge_and_home_projection_readiness_missing'
