...
Assert-Protocol ($source.Contains('[Convert]::ToBase64String') -and $source.Contains("'^[A-Za-z0-9+/=]+$'") -and $source.Contains('base64 -d | sh -eu -s')) 'snapshot_fqa_durable_recovery_ingress_hardening_missing'
