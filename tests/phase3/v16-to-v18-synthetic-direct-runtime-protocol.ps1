...
# Static-only contract for the attempt35 orchestration layer. It opens
...
Assert-True ($runner.Contains("`$attempt = 'attempt35'") -and $runner.Contains("`$httpPort = '11794'") -and $runner.Contains("`$compatPort = '11795'") -and $runner.Contains("`$composeProject = 'class_archive_v18_synthetic_migration_attempt35'")) 'direct_runtime_attempt35_identity_not_fixed'
