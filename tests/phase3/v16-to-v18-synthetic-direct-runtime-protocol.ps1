...
# Static-only contract for the attempt40 orchestration layer. It opens
...
Assert-True ($runner.Contains("`$attempt = 'attempt40'") -and $runner.Contains("`$httpPort = '11804'") -and $runner.Contains("`$compatPort = '11805'") -and $runner.Contains("`$composeProject = 'class_archive_v18_synthetic_migration_attempt40'")) 'direct_runtime_attempt40_identity_not_fixed'
