...
# Static-only contract for the attempt36 orchestration layer. It opens
...
Assert-True ($runner.Contains("`$attempt = 'attempt36'") -and $runner.Contains("`$httpPort = '11796'") -and $runner.Contains("`$compatPort = '11797'") -and $runner.Contains("`$composeProject = 'class_archive_v18_synthetic_migration_attempt36'")) 'direct_runtime_attempt36_identity_not_fixed'
