...
# Static-only contract for the attempt26 orchestration layer. It opens
...
Assert-True ($runner.Contains("`$attempt = 'attempt26'") -and $runner.Contains("`$httpPort = '11090'") -and $runner.Contains("`$compatPort = '11091'") -and $runner.Contains("`$composeProject = 'class_archive_v18_synthetic_migration_attempt26'")) 'direct_runtime_attempt26_identity_not_fixed'
