...
# Static-only contract for the attempt25 orchestration layer. It opens
...
Assert-True ($runner.Contains("`$attempt = 'attempt25'") -and $runner.Contains("`$httpPort = '10990'") -and $runner.Contains("`$compatPort = '10991'") -and $runner.Contains("`$composeProject = 'class_archive_v18_synthetic_migration_attempt25'")) 'direct_runtime_attempt25_identity_not_fixed'
