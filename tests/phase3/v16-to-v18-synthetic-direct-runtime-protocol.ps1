...
# Static-only contract for the attempt34 orchestration layer. It opens
...
Assert-True ($runner.Contains("`$attempt = 'attempt34'") -and $runner.Contains("`$httpPort = '11792'") -and $runner.Contains("`$compatPort = '11793'") -and $runner.Contains("`$composeProject = 'class_archive_v18_synthetic_migration_attempt34'")) 'direct_runtime_attempt34_identity_not_fixed'
