...
$assert(str_contains($source['runner'], "[ValidateSet('attempt8', 'attempt9', 'attempt10', 'attempt11', 'attempt12', 'attempt13', 'attempt14', 'attempt15', 'attempt16', 'attempt17', 'attempt18')]")
...
$assert(str_contains($source['runner'], 'function Get-FileSha256') && str_contains($source['runner'], 'Import-Module -Name Microsoft.PowerShell.Utility -ErrorAction Stop')
    && str_contains($source['runner'], "Stop-V18SyntheticMigration 'file_hash_command_unavailable'"), 'explicit_file_hash_module_gate_missing');
