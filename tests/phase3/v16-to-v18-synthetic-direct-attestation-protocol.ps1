...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt14'") -and $source.Contains("`$httpPort = '9890'") -and $source.Contains("`$compatPort = '9891'")) 'direct_attestation_surface_or_attempt_invalid'
