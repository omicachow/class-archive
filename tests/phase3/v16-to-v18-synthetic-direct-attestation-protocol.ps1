...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt25'") -and $source.Contains("`$httpPort = '10990'") -and $source.Contains("`$compatPort = '10991'")) 'direct_attestation_surface_or_attempt_invalid'
