...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt40'") -and $source.Contains("`$httpPort = '11804'") -and $source.Contains("`$compatPort = '11805'")) 'direct_attestation_surface_or_attempt_invalid'
