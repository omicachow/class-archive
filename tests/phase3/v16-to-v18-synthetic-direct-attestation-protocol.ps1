...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt15'") -and $source.Contains("`$httpPort = '9990'") -and $source.Contains("`$compatPort = '9991'")) 'direct_attestation_surface_or_attempt_invalid'
