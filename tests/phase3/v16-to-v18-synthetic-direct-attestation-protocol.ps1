...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt24'") -and $source.Contains("`$httpPort = '10890'") -and $source.Contains("`$compatPort = '10891'")) 'direct_attestation_surface_or_attempt_invalid'
