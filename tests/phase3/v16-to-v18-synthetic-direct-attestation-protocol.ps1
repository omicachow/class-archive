...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt23'") -and $source.Contains("`$httpPort = '10790'") -and $source.Contains("`$compatPort = '10791'")) 'direct_attestation_surface_or_attempt_invalid'
