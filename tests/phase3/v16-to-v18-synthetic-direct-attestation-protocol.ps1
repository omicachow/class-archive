...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt36'") -and $source.Contains("`$httpPort = '11796'") -and $source.Contains("`$compatPort = '11797'")) 'direct_attestation_surface_or_attempt_invalid'
