...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt28'") -and $source.Contains("`$httpPort = '11290'") -and $source.Contains("`$compatPort = '11291'")) 'direct_attestation_surface_or_attempt_invalid'
