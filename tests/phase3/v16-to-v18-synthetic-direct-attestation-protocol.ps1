...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt35'") -and $source.Contains("`$httpPort = '11794'") -and $source.Contains("`$compatPort = '11795'")) 'direct_attestation_surface_or_attempt_invalid'
