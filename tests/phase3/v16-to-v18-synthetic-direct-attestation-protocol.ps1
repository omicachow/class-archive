...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt39'") -and $source.Contains("`$httpPort = '11802'") -and $source.Contains("`$compatPort = '11803'")) 'direct_attestation_surface_or_attempt_invalid'
