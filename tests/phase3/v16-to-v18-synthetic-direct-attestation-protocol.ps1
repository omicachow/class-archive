...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt19'") -and $source.Contains("`$httpPort = '10390'") -and $source.Contains("`$compatPort = '10391'")) 'direct_attestation_surface_or_attempt_invalid'
