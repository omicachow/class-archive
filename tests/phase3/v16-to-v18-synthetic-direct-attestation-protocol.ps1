...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt26'") -and $source.Contains("`$httpPort = '11090'") -and $source.Contains("`$compatPort = '11091'")) 'direct_attestation_surface_or_attempt_invalid'
