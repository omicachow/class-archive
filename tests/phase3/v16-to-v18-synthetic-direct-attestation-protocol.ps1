...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt27'") -and $source.Contains("`$httpPort = '11190'") -and $source.Contains("`$compatPort = '11191'")) 'direct_attestation_surface_or_attempt_invalid'
