...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt31'") -and $source.Contains("`$httpPort = '11590'") -and $source.Contains("`$compatPort = '11591'")) 'direct_attestation_surface_or_attempt_invalid'
