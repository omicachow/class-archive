...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt30'") -and $source.Contains("`$httpPort = '11490'") -and $source.Contains("`$compatPort = '11491'")) 'direct_attestation_surface_or_attempt_invalid'
