...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt32'") -and $source.Contains("`$httpPort = '11690'") -and $source.Contains("`$compatPort = '11691'")) 'direct_attestation_surface_or_attempt_invalid'
