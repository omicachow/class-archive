...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt16'") -and $source.Contains("`$httpPort = '10090'") -and $source.Contains("`$compatPort = '10091'")) 'direct_attestation_surface_or_attempt_invalid'
