...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt18'") -and $source.Contains("`$httpPort = '10290'") -and $source.Contains("`$compatPort = '10291'")) 'direct_attestation_surface_or_attempt_invalid'
