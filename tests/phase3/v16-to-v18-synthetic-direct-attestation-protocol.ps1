...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt29'") -and $source.Contains("`$httpPort = '11390'") -and $source.Contains("`$compatPort = '11391'")) 'direct_attestation_surface_or_attempt_invalid'
