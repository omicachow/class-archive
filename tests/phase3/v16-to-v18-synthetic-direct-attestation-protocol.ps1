...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt20'") -and $source.Contains("`$httpPort = '10490'") -and $source.Contains("`$compatPort = '10491'")) 'direct_attestation_surface_or_attempt_invalid'
