...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt33'") -and $source.Contains("`$httpPort = '11790'") -and $source.Contains("`$compatPort = '11791'")) 'direct_attestation_surface_or_attempt_invalid'
