...
Assert-True ($source.Contains("[ValidateSet('create', 'verify', 'status')]") -and $source.Contains("`$attempt = 'attempt34'") -and $source.Contains("`$httpPort = '11792'") -and $source.Contains("`$compatPort = '11793'")) 'direct_attestation_surface_or_attempt_invalid'
