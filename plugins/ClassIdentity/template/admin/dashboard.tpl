...
{if isset($CA_DASHBOARD)}
  {if $CA_DASHBOARD.production_blocked}<div class="ca-admin__blocked">禁止投入生产（PRODUCTION BLOCKED）— 安全或迁移门禁未通过，禁止导入真实照片、连接 NAS 或开放公网。</div>{/if}
  ...
  <h3>内容摘要</h3>
  <div class="ca-admin__grid">
    <div class="ca-admin__card"><div class="ca-admin__metric">{$CA_DASHBOARD.heritage_images|escape:'html'}</div><div class="ca-admin__label">往昔档案（HERITAGE）图片</div></div>
    <div class="ca-admin__card"><div class="ca-admin__metric">{$CA_DASHBOARD.living_images|escape:'html'}</div><div class="ca-admin__label">后来生活（LIVING）图片</div></div>
  ...
  <h3>系统门禁</h3>
  <div class="ca-admin__grid">
    <div class="ca-admin__card"><div class="ca-admin__metric">{$CA_DASHBOARD.media_guard|escape:'html'}</div><div class="ca-admin__label">媒体访问防护（MediaGuard）</div></div>
    ...
    <div class="ca-admin__card"><div class="ca-admin__metric">{$CA_DASHBOARD.migration|escape:'html'}</div><div class="ca-admin__label">身份系统迁移（ClassIdentity）</div></div>
    <div class="ca-admin__card"><div class="ca-admin__metric">{$CA_DASHBOARD.failed_manual_operations|escape:'html'} / {$CA_DASHBOARD.compensation_required_accounts|escape:'html'}</div><div class="ca-admin__label">人工失败（FAILED_MANUAL）/ 待补偿账号</div></div>
