# HumHub dependency matrix (comparison archive)
...
| Gallery | 1.7.1, SHA-256 `02454e…de44` | Manifest: HumHub 1.18 only; 1.8.x is for 1.19 | GNU AGPL v3 in `docs/LICENCE.md`; manifest omits it | [Marketplace downloads](https://marketplace.humhub.com/module/gallery/downloads) | Installed; never disable/uninstall without DB + upload backup and restore drill |
