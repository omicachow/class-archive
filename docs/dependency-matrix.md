...
tests, moderation/CSRF tests where applicable, photo UI smoke and a backup plus
restore drill. Before public release, add a license-compliant offline retention
